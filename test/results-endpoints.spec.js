...
describe('Results Endpoints', () => {
    ...
    before('cleanup', () => db('results').truncate())
  
    afterEach('cleanup', () => db('results').truncate())


  
    describe(`Unauthorized requests`, () => {
      const testResults = makeResultsArray()
    ...
    //   "diabetesType": "type 1"
      ...
      it(`responds with 401 Unauthorized for GET /api/results/:result_id`, () => {
        const secondBookmark = testResults[1]
        return supertest(app)
          .get(`/api/results/${secondresult_id}`)
          .expect(401, { error: 'Unauthorized request' })
      })
